...
const Contact = () => {
    return (
        <div className="container">
            ...
            <ul>
                <p>Email: <a href="mailto:deliveries@vunutule.com">deliveries@vunutule.com</a></p>
            ...
            <ul>
                <p>Email: <a href="mailto:managers@vunutule.com">managers@vunutule.com</a></p>
            </ul>
            <p>Stay updated with all things Vuna Tule by following us on:</p>
            <ul>
                <p>Instagram: <a href="https://instagram.com/VunaTuleOfficial">@VunaTuleOfficial</a></p>
                <p>Facebook: <a href="https://facebook.com/VunaTuleOfficial">Vuna Tule Official</a></p>
                <p>Twitter: <a href="https://twitter.com/VunaTuleTweets">@VunaTuleTweets</a></p>
            </ul>
        </div>
    );
}
